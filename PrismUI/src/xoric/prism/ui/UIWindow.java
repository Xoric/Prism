...
public class UIWindow extends UIFrame implements IUIButtonHost, IMetaChild_in
{
	...
	public void makeResizable(boolean b)
	{
		if (b && cornerRect == null)
		{
			...
			cornerRect.setSize(AllArt.frames.getMeta().getObject(3).getSize());
	...
	public void draw(IUIRenderer2 ren) throws PrismException
	{
		...
		if (cornerRect != null)
		{
			AllTools.uiDrawer.setup(0, 3, 0);
			AllTools.uiDrawer.drawSingle(cornerRect.getTopLeft());
		}
