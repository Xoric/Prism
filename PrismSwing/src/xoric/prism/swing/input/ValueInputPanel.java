...
public abstract class ValueInputPanel extends JPanel implements ActionListener, IValueInput
{
	...
	public ValueInputPanel(String name, IValueInputListener listener)
	{
